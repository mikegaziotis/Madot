...
public class ApiVersionTests
{
    ...
    public async void GetApiVersion()
    {
        ...
        var queryHandler = new ApiVersionGetByIdQueryHandler(new MadotDbContext(new SqlConfigurationProvider()));
    ...
    public async void GetLatestApiVersion()
    {
        ...
        var queryHandler = new ApiVersionGetLatestByApiIdQueryHandler(new MadotDbContext(new SqlConfigurationProvider()));
    ...
    public async void GetAllApiVersions()
    {
        ...
        var queryHandler = new ApiVersionGetByApiIdQueryHandler(new MadotDbContext(new SqlConfigurationProvider()));
