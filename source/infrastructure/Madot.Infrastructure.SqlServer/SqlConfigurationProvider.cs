...
public class SqlConfigurationProvider: IDatabaseConfigurationProvider
{
    ...
    public void BuildModel(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AppCommonPage>(entity =>
        {
            entity
                .ToTable("AppCommonPage")
                .ToTable(tb => tb.IsTemporal(ttb =>
                    {
                        ttb.UseHistoryTable("AppCommonPage_History", "dbo");
                        ttb
                            .HasPeriodStart("ValidFrom")
                            .HasColumnName("ValidFrom");
                        ttb
            ...
            entity.HasIndex(e => e.OrderId, "IX_AppCommonPage_OrderId")
                .IsUnique()
